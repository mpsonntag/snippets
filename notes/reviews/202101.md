...
Outcome: we invested two days in piecing together the information from the various sources provided
...
does not specify that this is a github tag pointing to the specific v1.0 release and also does not state, that it points on the `neurons` branch.
