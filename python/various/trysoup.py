...
def curl_response_body(get_url):
    """
    Executes curl using the provided URL, parses the request headers,
    decodes the request body using the encoding found in the 'content-type'
    request header or 'UTF-8' as fallback and returns the result as string.
    :param get_url: string containing the URL of interest.
    :return: String with the decoded body of the curl request.
    """
