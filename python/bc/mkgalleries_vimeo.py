...
def write_session_index(data: List[Dict[str, str]], filepath: pl.Path):
    ...
    for session, items in session_posters.items():
        ...
        for item in items:
            ...
            sorted_list.append((int(item["poster_board_number"]), list_item))
