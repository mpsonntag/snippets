...
if not CheckVer(odml.__version__) < CheckVer('1.4.0'):
    print("odml version 1.3 or lesser required")
    quit()
...
prop = odml.Property(name="prop one", value="", definition="def prop1",
                     dependency="dep p1", dependency_value="dep val p1")
doc.sections[0].append(prop)

prop = odml.Property(name="prop two", value="", definition="def prop2",
                     dependency="dep p2", dependency_value="dep val p2")
doc.sections[0].append(prop)

prop = odml.Property(name="prop three", value="", definition="def prop3",
                     dependency="dep p3", dependency_value="dep val p3")
doc.sections[0].append(prop)

prop = odml.Property(name="prop one", value="", definition="def prop1",
                     dependency="dep p1", dependency_value="dep val p1")
doc.sections[0].sections[0].append(prop)
