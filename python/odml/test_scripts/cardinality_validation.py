...
prop = odml.Property(name="prop_invalid_max_val", values=test_val, val_cardinality=test_card, parent=sec)
valid = Validation(doc)
print(valid.errors)
...
prop = odml.Property(name="prop_invalid_min_val", values=test_val, val_cardinality=test_card, parent=sec)
valid = Validation(doc)
print(valid.errors)
