...
def object_required_attributes(obj):
    ...
    """
    # Retrieving the functions own name from the stack to use it as Validation ID.
    # Not sure if this is the best idea, but convenient.
    validation_id = sys._getframe().f_code.co_name
