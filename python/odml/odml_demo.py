...
prop.value = "https://gin.g-node.org/mpsonntag/demo"
...
prop.value = [10, 10, 180, 180, 180, 60]
prop.unit = "s"

prop = odml.Property(name="description", parent=subsec)
prop.value = "Recording start in the first 10s, 10s at 21% oxygen, ramp down over 180s" \
...
prop = odml.Property(name="shifting_times", parent=subsec)
prop.value = [110, 360, 150]
prop.unit = "s"

prop = odml.Property(name="description", parent=subsec)
prop.value = "Recording start at 21% oxygen, stays there for 110s after this a shift" \
...
prop.value = ["well-fed", "starving"]

subsec = odml.Section(name="well-fed", parent=sec)
prop = odml.Property(name="description", parent=subsec)
prop.value = "Animals are picked from a bacterial lawn to an agar plate containing no " \
